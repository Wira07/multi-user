                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-header">
                            ...
                            <p>Silakan isi formulir berikut dengan informasi lengkap</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.store') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" required rows="3">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
